...
Documentación, Desarrollo colaborativo y Respaldo del proyecto integrador para la asignatura de 
Integradora I

## Comandos Básicos para documentación, utilizando el estándar de Markdown (nd)
Markdown es el estandar utilizado pot GIT y Github para maquetar la documentación de proyectos, lo que
...
Para poder ealizar una buena documentación del proyecto debemos, dsitribuir correctamente los 
...
para poder ponerlo en negrita, este debera ser encerrado entre dos pares de *
 ...
 Texto Texto Texto Texto Texto Texto Texto Texto Texto Texto Texto Texto Texto Texto Texto Texto Texto **Texto importante** Texto Texto 
...
Texto Texto Texto Texto Texto Texto Texto Texto Texto Texto Texto Texto Texto Texto Texto Texto Texto _Texto importante_ Texto Texto Texto 
Texto Texto Texto Texto Texto Texto Texto Texto Texto Texto Texto Texto Texto Texto Texto Texto Texto Texto Texto Texto Texto Texto Texto 
Texto Texto Texto Texto Texto Texto Texto Texto Texto Texto Texto Texto Texto Texto Texto Texto Texto Texto Texto Texto Texto Texto Texto
 Texto Texto Texto Texto Texto Texto Texto Texto
...
Las ligas son utilizadas para vincular elemontos o referencias del proyecto 
dentro del mismo repositorio o fuera de el. y se maqueten utilizando los 
corchetes \[ \], inmediatamente despues pondremos la liga de la referencia entre 
parentesis \( \)
...
En caso de fusionar las celdas en columnas usaremos la propiedad *colspon* del tag \<td>
y en el caso de fusion de filas usamos la propiedad *rowspon*
